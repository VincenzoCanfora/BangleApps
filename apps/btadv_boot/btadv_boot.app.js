...
var enableSensors_1 = function () {
    Bangle.setBarometerPower(settings_1.bar, "btadv_boot");
    if (!settings_1.bar)
        bar_1 = undefined;
    Bangle.setGPSPower(settings_1.gps, "btadv_boot");
    if (!settings_1.gps)
        gps_1 = undefined;
    Bangle.setHRMPower(settings_1.hrm, "btadv_boot");
    if (!settings_1.hrm)
        hrm_1 = hrmAny_1 = undefined;
    Bangle.setCompassPower(settings_1.mag, "btadv_boot");
    if (!settings_1.mag)
        mag_1 = undefined;
};
